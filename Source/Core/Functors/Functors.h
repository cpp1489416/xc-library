...
XC_BEGIN_NAMESPACE_2(XC, Functors)
{
	...
	template <typename T>
	class GreaterEqual : public BinaryFunctor<T, T, bool>
	{
	public:
		bool operator () (const T& x, const T& y) const
		{
	...
	template <typename T>
	class LessEqual : public BinaryFunctor<T, T, bool>
	{
	public:
		bool operator () (const T& x, const T& y) const
		{
	...
	template <typename T>
	class LogicalAnd : public BinaryFunctor<T, T, bool>
	{
	public:
		bool operator () (const T& x, const T& y) const
		{
	...
	template <typename T>
	class LogicalOr : public BinaryFunctor<T, T, bool>
	{
	public:
		bool operator () (const T& x, const T& y) const
		{
	...
	template <typename T>
	class LogicalNot : public UnaryFunctor<T, bool>
	{
	public:
	...
	template <typename T>
	class Identity : public UnaryFunctor<T, T>
	{
	public:
