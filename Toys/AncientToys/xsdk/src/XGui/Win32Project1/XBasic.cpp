    ...
    ID3D11RenderTargetView **renderTargetView)
{
   ...
   D3D11_RASTERIZER_DESC _rasterDesc;
    ...
    _rasterDesc.FillMode = D3D11_FILL_MODE::D3D11_FILL_SOLID;
    ...
    (*d3d11Device)->CreateRasterizerState(&_rasterDesc, &rstate);

    (*d3d11DevCon)->RSSetState(rstate);
    
    xBasicChangeSize(*d3d11Device, *d3d11DevCon, *SwapChain, renderTargetView, 1, 1);
}
    ...
    ID3D11PixelShader **PS)
{
    ...
    hr = D3DCompileFromFile(fileName, 0, 0, "VS", "vs_5_0", 0, 0, VS_Buffer, 0);
    hr = D3DCompileFromFile(fileName, 0, 0, "PS", "ps_5_0", 0, 0, PS_Buffer, 0);
