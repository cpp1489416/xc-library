#include "TextureTechnique.h"


void TextureTechnique::AddThing(Thing * thing)
{
...
void TextureTechnique::SetPicturePath(const char * path)
{
    mProgram.Bind();
...
void TextureTechnique::OnCreate()
{
